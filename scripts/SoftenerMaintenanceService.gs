(function(global) {
  (function(ns) {
    ...
    const SOFTENER_COLUMNS = Object.freeze([
      ...
      { header: 'Equipo_Caudal', path: 'seccion_B_equipo.caudal', formatter: 'number' },
      { header: 'Equipo_Capacidad', path: 'seccion_B_equipo.capacidad', formatter: 'number' },
      { header: 'Parametros_DurezaEntrada', path: 'seccion_C_parametros.dureza_entrada', formatter: 'number' },
      { header: 'Parametros_DurezaSalida', path: 'seccion_C_parametros.dureza_salida', formatter: 'number' },
      { header: 'Parametros_PH', path: 'seccion_C_parametros.ph', formatter: 'number' },
      { header: 'Parametros_Cloro', path: 'seccion_C_parametros.cloro', formatter: 'number' },
